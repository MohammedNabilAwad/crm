...
<table border='0' cellpadding='0' cellspacing='0' width='100%'>
    <tr>
        ...
        <td class='dataField' width='1%'>
            {{*
            هذه شفرة برمجية مخصصة يمكنك تعيينها للظهور في العمود الثاني من جدول العنوان.
             من الأمثلة على ذلك زر "نسخ" الموجود في عرض تفاصيل الحسابات.
             راجع ملف modules/Accounts/views/view.detail.php لمعرفة القيمة التي يتم تعيينها
            *}}
