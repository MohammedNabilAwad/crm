...
// OPENSYMBOLMOD - Started by Rahat Ali
//******************************************************************************************
...
if(!empty($sugar_config['osy_mode']['jb_plugin']['img_path']))
{
//	if($name === '/'){
//		$config['img_path'] = $sugar_config['osy_mode']['jb_plugin']['img_path'];
//	}
//	else{
//		if( $sugar_config['osy_mode']['jb_plugin']['add_abs_path'] ) {
//			$config['img_path'] = $name . $sugar_config['osy_mode']['jb_plugin']['img_path'];
//		} else {
//			$config['img_path'] = $sugar_config['osy_mode']['jb_plugin']['img_path'];
//		}
//	}
    $config['img_path'] = $sugar_config['site_url'] . $sugar_config['osy_mode']['jb_plugin']['img_path'];
    $config['upload_path'] = $filename . $sugar_config['osy_mode']['jb_plugin']['img_path'];
}
//******************************************************************************************
// OPENSYMBOLMOD - Stopped by Rahat Ali
/*-------------------------------------------------------------------
| 
