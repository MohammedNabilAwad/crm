<?php 
 $GLOBALS["dictionary"]["osy_other_contacts"]=array (
  'table' => 'osy_other_contacts',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'osy_other_contacts_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'osy_other_contacts_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'osy_other_contacts_assigned_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'osy_other_contacts_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'osy_other_contacts_email_addresses',
      'module' => 'EmailAddress',
      'source' => 'non-db',
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'osy_other_contactscategory_c',
      'custom_module' => 'osy_other_contacts',
    ),
    'gender_c' => 
    array (
      'inline_edit' => '1',
