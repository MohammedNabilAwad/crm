<?php 
 $GLOBALS["dictionary"]["Mem_Memos"]=array (
  'table' => 'mem_memos',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mem_memos_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mem_memos_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mem_memos_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_mem_memos',
    ...
    'accounts_mem_memos_1accounts_ida' => 
    array (
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Mem_Memostype_activity_c',
      'custom_module' => 'Mem_Memos',
    ),
    'passport_number_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'رقم الجواز',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Mem_Memospassport_number_c',
      'custom_module' => 'Mem_Memos',
    ),
    'commercial_name_english_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'الإسم التجاري انجليزي',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Mem_Memoscommercial_name_english_c',
      'custom_module' => 'Mem_Memos',
    ),
  ),
  'relationships' => 
