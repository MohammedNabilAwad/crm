...
$mod_strings = array(
	...
	'ERR_UW_MYSQL_VERSION'						=> 'SuiteCRM exige MySQL version 4.1.2 ou +. Version trouvée : ',
	'ERR_UW_OCI8_VERSION'				        => 'Votre version actuelle d&#39;Oracle n&#39;est pas supportée par SuiteCRM. Vous devez installer une version compatible avec SuiteCRM. Veuillez consulter la matrice de compatibilité des "Release Notes" pour les versions d&#39;Oracle supportées. Version actuelle : ',
	...
	'LBL_UW_CONTINUE_CONFIRMATION'              => 'Cette nouvelle version de SuiteCRM contient un nouvel accord de licence. Voulez-vous continuer ?',
	...
	'LBL_UW_START_DESC2'						=> 'Nous vous recommandons fortement de mettre à jour une copie de votre serveur de production. Merci de sauvegarder votre base de données ainsi que les fichiers systèmes (tous les fichiers du dossier de votre SuiteCRM) avant de lancer cette opération.',
    ...
    'LBL_UW_DORP_THE_OLD_SCHMEA' 				=> 'Voulez-vous que SuiteCRM supprime le schéma 451 déprécié ?',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'Le fichier uploadé est incompatible avec cette version de SuiteCRM: ',
    'ERROR_PHP_VERSION_INCOMPATIBLE' => 'Le fichier téléchargé n\'est pas compatible avec cette version de PHP : ',
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Le fichier uploadé n&#39; est pas compatible avec cette version de SuiteCRM :',
    'ERROR_FLAVOR_INCOMPATIBLE'  => 'Le fichier uploadé n&#39; est pas compatible avec cette version de SuiteCRM: ',
