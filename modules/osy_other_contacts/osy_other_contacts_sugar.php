 ...
 * PLACE ANY CUSTOMIZATIONS IN osy_other_contacts
 */

require_once('include/SugarObjects/templates/person/Person.php');

class osy_other_contacts_sugar extends Person implements EmailInterface{
	var $new_schema = true;
	var $module_dir = 'osy_other_contacts';
	var $object_name = 'osy_other_contacts';
	var $table_name = 'osy_other_contacts';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		function osy_other_contacts_sugar(){	
		parent::Person();
	}
