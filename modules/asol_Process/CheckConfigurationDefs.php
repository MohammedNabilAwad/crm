...
//*********************//
	...
	////////////////
	//**********************************//
	//***asolWFM_TranslateLabels***//
	//**********************************//
	echo "<span style='font-weight: bold;'>· asolWFM_TranslateLabels:</span></td><td width='27.5%'>";
	echo asol_CheckConfigurationDefsFunctions::checkConfiguration('asolWFM_TranslateLabels');
	//**********************************//
	//***asolWFM_TranslateLabels***//
	//**********************************//
	...
	//***MAX_loops***//
	//*****************************************//
	echo "<span style='font-weight: bold;'>· MAX_loops:</span></td><td width='27.5%'>";
	echo asol_CheckConfigurationDefsFunctions::checkConfiguration('MAX_loops');
	//*****************************************//
	//***MAX_loops***//
	//*****************************************//
	...
	////////////////
	//**********************************//
	//***MAX_working_nodes_executed_in_one_php_instance***//
	//**********************************//
	echo "<span style='font-weight: bold;'>· MAX_working_nodes_executed_in_one_php_instance:</span></td><td width='27.5%'>";
	echo asol_CheckConfigurationDefsFunctions::checkConfiguration('MAX_working_nodes_executed_in_one_php_instance');
	//**********************************//
	//***MAX_working_nodes_executed_in_one_php_instance***//
	//**********************************//
	...
	//*****************************************//
	//***WFM_logLevelForInfoLogs***//
	//*****************************************//
	echo "<span style='font-weight: bold;'>· WFM_logLevelForInfoLogs:</span></td><td width='27.5%'>";
	echo asol_CheckConfigurationDefsFunctions::checkConfiguration('WFM_logLevelForInfoLogs');
	//*****************************************//
	//***WFM_logLevelForInfoLogs***//
	//*****************************************//
