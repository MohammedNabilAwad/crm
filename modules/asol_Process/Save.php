...
$focus->trigger_module = ($_REQUEST['alternative_database'] >= 0) ? $sugar_config["asolReportsAlternativeDbConnections"][$_REQUEST['alternative_database']]["asolReportsDbName"].".".$_REQUEST['alternative_database_table']." (External_Table)" : $_REQUEST['trigger_module'];
