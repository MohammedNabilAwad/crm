...
'LBL_SP_WELCOME'=>'Bienvenue au Studio pour SuiteCRM. Vous pouvez choisir d’éditer des modules ici ou synchroniser à une instance de portail. <br>S’il vous plaît choisissez dans la liste ci-dessous.',
'LBL_SP_SYNC'=>'Synchro portail',
'LBL_SYNCP_WELCOME'=>'S’il vous plaît entrez l’url de l’instance du portail que vous souhaitez mettre à jour puis appuyez sur le bouton Go. <br>, Cela fera apparaître une invite de commander pour votre nom d’utilisateur et mot de passe. <br>S’il vous plaît entrer votre nom d’utilisateur SuiteCRM et le mot de passe et appuyez sur le bouton Sync de commencer.',
