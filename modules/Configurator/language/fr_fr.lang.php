...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_MAILMERGE_DESC' => 'Cet indicateur doit être vérifié que si vous avez le SuiteCRM Plugin pour Microsoft&reg; Word&reg;.',
	...
	'LBL_PORTAL_ON_DESC' => 'Permet aux utilisateurs de gérer les informations utilisateur du portail dans les enregistrements de contacts. Les utilisateurs du portail peuvent accéder cas, Bugs, articles de la Base de connaissances et d’autres données par le portail de SuiteCRM.',
    ...
    'LBL_LDAP_ADMIN_USER_DESC'=>'Utilisé pour rechercher un utilisateur SuiteCRM [Doit être entièrement qualifié]. Une connexion anonyme sera réalisée si non fourni.',
	...
	'SHOW_DOWNLOADS_TAB_HELP' =>'Lorsque sélectionné, l’onglet de téléchargement apparaîtra dans les paramètres utilisateur et fournira aux utilisateurs un accès aux plug-ins SuiteCRM et à d\'autres fichiers disponibles',
    ...
    'LBL_PDF_INSTRUCTIONS' => 'Consignes',
    'PDF_INSTRUCTIONS_ADD_FONT' => '<<< BSOFR
Polices prises en charge par le PDF :
<ul>
...
<br>
Si vous choisissez de ne pas incorporer vos polices dans le fichier PDF, le fichier PDF généré sera plus léger, mais une police de substitution sera utiliser si elle n’est pas disponible dans le système de votre lecteur.
<br><br>
Ajouter une police PDF à SuiteCRM exige de suivre les étapes 1 et 2 de la documentation de TCPDF Fonts disponible dans la section "documents" du <a href="http://www.tcpdf.org" target="_blank"> site Web de TCPDF</a>.
<br><br>
Les utilitaires pfm2afm et ttf2ufm sont disponible dans les polices/utils dans le package TCPDF que vous pouvez télécharger sur la rubrique « Télécharger » du <a href="http://www.tcpdf.org" target="_blank"> site Web de TCPDF</a>.
<br><br>
Charge le fichier métrique généré à l’étape 2 et votre fichier de polices ci-dessous.
BSOFR',
...
// Wizard
    ...
    'LBL_WIZARD_TITLE' => 'Assistant de Configuration',
    ...
    'LBL_WIZARD_FINISH' => 'Cliquez <b>Continuer</b> pour configurer vos paramétres utilisateur.<br/><br />Pour configurer des paramètres système supplémentaires, cliquez <a href="index.php?module=Administration&action=index" target="_blank">ici</a>.',
