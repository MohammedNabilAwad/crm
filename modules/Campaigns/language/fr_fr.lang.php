...
$mod_strings = array (
	...
	'LBL_INBOUND_EMAIL_CREATE' => 'Créer des courriers électroniques entrants',
	'LBL_INBOUND_EMAIL_CREATE_TITLE' => 'Créer des courriers électroniques entrants (info)',
	'LBL_STATUS_TEXT' =>  'Statut:' ,
	'LBL_FROM_MAILBOX_NAME'=>'Compte de gestion des retours:',
	'LBL_FROM_MAILBOX_TITLE'=>'Compte e-mail de gestion des retours:',
	'LBL_OUTBOUND_MAILBOX_NAME' => 'Compte de courrier électronique sortant :',
	...
	'LBL_TEMPLATE_FIELD' => 'Modèle d&#39;email utilisé:',
	'LBL_SUBJECT' => 'Sujet : ',
	...
	'LBL_WIZARD_SUBSCRIPTION_MESSAGE' => 'Une Newsletter doit avoir au moins trois "Listes de Cibles" définies. Vous pouvez utiliser des listes existantes ou laisser SuiteCRM créer des listes vides automatiquement.',
	...
	'LBL_WIZARD_TARGET_MESSAGE2' => 'Créer une nouvelle liste cible:',
	...
	'LBL_WIZ_EMAILTPL_TITLE' => 'Sélectionnez le modèle de courrier électronique',
	'LBL_WIZ_TEST_EMAIL_TITLE' => 'Courriel test',
	...
	'LBL_EMAIL_SETUP_DESC'                      => 'Remplissez le formulaire ci-dessous pour modifier les paramètres Système SuiteCRM utilisés pour envoyer les Emails de Campagne.',
	...
	'LBL_CREATE_WEB_TO_LEAD_FORM' => 'Créer un formulaire Web de collecte de Prospect',
	...
	'LBL_IMPORT_PROSPECTS'=>'Importer des cibles',
	...
	'LBL_EDIT_EMAIL_TEMPLATE_BTN'	=> 'Éditer',
	'LBL_DELETE_EMAIL_TEMPLATE_BTN'	=> 'Supprimer',
	...
	'LBL_EMAIL_TEMPLATE_TITLE' => 'Détails du modèle de l\'e-mail',
	'LBL_SAVE_TEMPLATE_BTN' => 'Sauvegarder',
	'LBL_CREATE_TEMPLATE_BTN' => 'Créer',
	'LBL_EDIT_TEMPLATE_BTN' => 'Éditer',
	...
	'LBL_OVERWRITE_TEMPLATE_CONFIRM_DIALOG' => 'Souhaitez-vous remplacer le modèle sélectionné ? Sélectionnez « Annuler » pour continuer sans enregistrer les modifications.',
	'LBL_CREATE_MARKETING_RECORD' => 'Suivant',
	'LBL_NO_TEMPLATE_SELECTED' => 'Modèle d\'E-mail non sélectionné',
	'LBL_SELECT_TEMPLATE' => 'Modèles',
	'LBL_WIZARD_ADD_TARGET' => 'Ajouter des cibles existantes :',
	...
	'LBL_SELECT_EMAIL_TRACKER' => 'Veuillez sélectionner un tracker email.',
	...
	'LBL_STEP_INFO_CAMPAIGN_HEADER' => 'Veuillez entrer le nom de la campagne et sélectionnez le statut',
		'LBL_STEP_INFO_TARGET_LIST_EMAIL' => 'Sélectionnez votre liste cible pour cette campagne.  Pour envoyer des emails de test, vous devez inclure une liste de cibles de type Test',
	...
	'LBL_STEP_INFO_BUDGET' => 'Entrer le budget pour calculer le Retour sur Investissement (ROI).',
	'LBL_EMAIL_TRACKERS' => 'Chaque campagne doit avoir au moins trois listes de cibles (abonnement, désabonnement et Test). Si la liste n’est pas spécifiée, une liste cible vide sera créée lorsque vous cliquez sur suivant.',
	'LBL_NO_SUBJECT' => 'Le modèle d’e-mail sélectionné n\'a pas de sujet',
	'LBL_NO_HTML_BODY_CONTENTS' => 'Le modèle d’e-mail sélectionné n’a pas un corps html',
	...
	'LBL_NEWSLETTER_TITLE' => ' Une campagne de newsletter est un type de campagne d’email, qui vous permet d’envoyer un email à une liste cible unique.',
	...
	'LBL_NON_EMAIL_TITLE' => 'Une campagne d’e-mail non est une campagne qui n’envoie pas un e-mail.',
