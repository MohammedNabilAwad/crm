...
$mod_strings  = array(
  ...
  'LBL_NEW_PAGE_FEEDBACK' => 'Vous avez créé une nouvelle page. Vous pouvez ajouter un nouveau contenu avec l\'option Ajouter un dashlet.',
  ...
  'LBL_HOME_PAGE_3_NAME' => 'Assistance',
...
//ABOUT page
    ...
    'LBL_ADD_TERM_COM' => '<P> Les interfaces utilisateurs interactives dans des versions modifiées de codes source et objet de ce programme doivent afficher les Notices Légales Appropriées, comme l\'exige l\'article 5 de la version de licence GNU Affero General Public License 3. Conformément à l\'article 7 (b) de la GNU General License version 3 publique, ces notices légales Appropriées doiventt conserver l\'affichage de la & quot; Propulsé par SuiteCRM & quot; logo. Si l\'affichage du logo ne est pas raisonnablement possible pour des raisons techniques, les Notices Légales Appropriées doit afficher les mots & quot; Propulsé par SuiteCRM & quot;. </ P>',
  ...
  'LBL_DETAILS_SUGAREXCHANGE' => 'Acheter et vendre des extensions de SuiteCRM certifiées',
  'LBL_TRAINING' => 'Formation',
  'LBL_DETAILS_TRAINING' => 'Apprenez en plus sur SuiteCRM en utilisant le contenu d\'apprentissage en ligne et interactif',
  'LBL_FORUMS' => 'Forums',
  'LBL_DETAILS_FORUMS' => 'Discuter avec les développeurs et les utilisateurs experts de la communauté SuiteCRM',
  'LBL_WIKI' => 'Wiki',
  ...
  'LBL_DETAILS_DEVSITE' => 'Découvrez ressources, tutoriels et liens utiles pour vous aider à accélérer votre déploiement de SuiteCRM',
