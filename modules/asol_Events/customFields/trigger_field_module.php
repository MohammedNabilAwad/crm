...
$selectModules = "<select id='triggerModule' name='triggerModule' disabled='true' onChange='this.form.module.value=\"".$_REQUEST['module']."\"; this.form.action.value=\"".$_REQUEST['action']."\"; this.form.event_conditions.value=\"\"; this.form.submit();'>";
