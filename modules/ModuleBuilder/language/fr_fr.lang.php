...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'studioWizard' => array(
            ...
            'sugarPortalBtn' => '<b>SuiteCRM portail Editor</b> permet de gérer et personnaliser le portail SuiteCRM.',
        ...
        'portalStyle' => array(
            'default' => 'Vous pouvez personnaliser l’apparence du portail SuiteCRM en utilisant une feuille de style. <br><br>Sélectionnez une <b>Feuille de Style</b> à uploader. <br> <br>La feuille de style sera exécutée dans le portail SuiteCRM la prochaine fois qu’une synchronisation sera effectuée.',
        ),
    ),
...
//STUDIO2
    ...
    'LBL_SUGAR_FIELDS_STAGE' => 'Champs SuiteCRM (cliquer sur les éléments à ajouter dans la zone de dépot)',
...
//AJAX STATUS
    ...
    'LBL_AJAX_RESPONSE_MESSAGE' => 'Cette opération est terminée avec succès',
...
//Revert Module labels
    ...
    'LBL_POPHELP_VALIDATE_US_PHONE' => 'Sélectionnez pour valider ce domaine pour l\'entrée d\'un numéro de téléphone à 10 chiffres, <br> avec l\'application pour le code du pays 1 pour appliquer un format Us au numéro de téléphone lorsque l\'enregistrement <br> est sauvegardé. Le format suivant sera appliqué: (xxx) xxx-xxxx.',
