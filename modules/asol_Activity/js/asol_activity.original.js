...
function generate_OldBean_NewBean_Changed_HTML_and_Remember_DataBase_if_needed(rowIndex, isRelated, cell_OldBean_NewBean_Changed_SelectedValue) {
	...
	var lbl_asol_old_bean = SUGAR.language.get('asol_Activity', 'LBL_ASOL_OLD_BEAN');
	var lbl_asol_new_bean = SUGAR.language.get('asol_Activity', 'LBL_ASOL_NEW_BEAN');
	var lbl_asol_changed = SUGAR.language.get('asol_Activity', 'LBL_ASOL_CHANGED');
	// END - Language Labels
...
function generate_IsChanged_HTML_and_Remember_DataBase_if_needed(rowIndex, cell_IsChanged_SelectedValue) {
	...
	// BEGIN - Language Labels
	var lbl_asol_true = SUGAR.language.get('asol_Activity', 'LBL_ASOL_TRUE');
	var lbl_asol_false = SUGAR.language.get('asol_Activity', 'LBL_ASOL_FALSE');
	// END - Language Labels
...
function generate_Operator_for_enum_HTML_and_Remember_DataBase_if_needed(rowIndex, cell_Operator_for_enum_SelectedValue) {
	...
	// BEGIN - Language Labels
	var lbl_equals = SUGAR.language.get('asol_Activity', 'LBL_EVENT_EQUALS');
	var lbl_not_equals = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_EQUALS');
	var lbl_one_of = SUGAR.language.get('asol_Activity', 'LBL_EVENT_ONE_OF');
	var lbl_not_one_of = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_ONE_OF');
	// END - Language Labels
...
function generate_Operator_for_int_HTML_and_Remember_DataBase_if_needed(rowIndex, cell_Operator_for_int_SelectedValue) {
	...
	var lbl_equals = SUGAR.language.get('asol_Activity', 'LBL_EVENT_EQUALS');
	var lbl_not_equals = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_EQUALS');
	var lbl_less_than = SUGAR.language.get('asol_Activity', 'LBL_EVENT_LESS_THAN');
	var lbl_more_than = SUGAR.language.get('asol_Activity', 'LBL_EVENT_MORE_THAN');
	// END - Language Labels
...
function generate_Operator_for_datetime_HTML_and_Remember_DataBase_if_needed(rowIndex, cell_Operator_for_datetime_SelectedValue) {
	...
	var lbl_equals = SUGAR.language.get('asol_Activity', 'LBL_EVENT_EQUALS');
	var lbl_not_equals = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_EQUALS');
	var lbl_before_date = SUGAR.language.get('asol_Activity', 'LBL_EVENT_BEFORE_DATE');
	var lbl_after_date = SUGAR.language.get('asol_Activity', 'LBL_EVENT_AFTER_DATE');
	var lbl_between = SUGAR.language.get('asol_Activity', 'LBL_EVENT_BETWEEN');
	var lbl_not_between = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_BETWEEN');
	var lbl_last = SUGAR.language.get('asol_Activity', 'LBL_EVENT_LAST');
	var lbl_not_last = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_LAST');
	var lbl_this = SUGAR.language.get('asol_Activity', 'LBL_EVENT_THIS');
	var lbl_not_this = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_THIS');
	var lbl_next = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NEXT');
	var lbl_not_next = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_NEXT');
	// END - Language Labels
...
function generate_var_fixed_str_for_First_Parameter_for_datetime_HTML_and_Remember_DataBase_if_needed(var_fixed_str_for_First_Paremeter_for_datetime_SelectedValue) {
	...
	// BEGIN - Language Labels
	var lbl_day = SUGAR.language.get('asol_Activity', 'LBL_EVENT_DAY');
	var lbl_week = SUGAR.language.get('asol_Activity', 'LBL_EVENT_WEEK');
	var lbl_month = SUGAR.language.get('asol_Activity', 'LBL_EVENT_MONTH');
	var lbl_nquarter = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NQUARTER');
	var lbl_fquarter = SUGAR.language.get('asol_Activity', 'LBL_EVENT_FQUARTER');
	var lbl_nyear = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NYEAR');
	var lbl_fyear = SUGAR.language.get('asol_Activity', 'LBL_EVENT_FYEAR');
	// END - Language Labels
...
function generate_First_Parameter_for_tinyint_HTML_and_Remember_DataBase_if_needed(rowIndex, cell_First_Parameter_for_tinyint_SelectedValue) {
	...
	// BEGIN - Language Labels
	var lbl_true = SUGAR.language.get('asol_Activity', 'LBL_EVENT_TRUE');
	var lbl_false = SUGAR.language.get('asol_Activity', 'LBL_EVENT_FALSE');
	// END - Language Labels
...
function generate_Operator_for_default_HTML_and_Remember_DataBase_if_needed(rowIndex, cell_Operator_for_default_SelectedValue) {
	...
	var lbl_equals = SUGAR.language.get('asol_Activity', 'LBL_EVENT_EQUALS');
	var lbl_not_equals = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_EQUALS');
	var lbl_like = SUGAR.language.get('asol_Activity', 'LBL_EVENT_LIKE');
	var lbl_not_like = SUGAR.language.get('asol_Activity', 'LBL_EVENT_NOT_LIKE');
	// END - Language Labels
...
function generate_Button_detele_row_HTML(rowIndex, value_type, key, is_related, index, options, options_db) {
	...
	// BEGIN - Language Labels
	var lbl_asol_delete_button = SUGAR.language.get('asol_Activity', 'LBL_ASOL_DELETE_BUTTON');
	var lbl_asol_delete_row_alert = SUGAR.language.get('asol_Activity', 'LBL_ASOL_DELETE_ROW_ALERT');
	// END - Language Labels
