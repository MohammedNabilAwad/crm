...
function additionalDetailsosy_service($fields) {
	static $mod_strings;
	...
	$editLink = "index.php?action=EditView&module=osy_service&record={$fields['ID']}"; 
	$viewLink = "index.php?action=DetailView&module=osy_service&record={$fields['ID']}";	
