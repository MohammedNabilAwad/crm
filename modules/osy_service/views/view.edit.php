...
class osy_serviceViewEdit extends ViewEdit
{
 	/**
 	...
 	public function display()
 	{
		...
		if (isset($this->bean->json_id) && !empty ($this->bean->json_id)) {
			$javascript = $json_config->get_static_json_server(false, true, 'osy_service', $this->bean->json_id);

		} else {
			$this->bean->json_id = $this->bean->id;
			$javascript = $json_config->get_static_json_server(false, true, 'osy_service', $this->bean->id);
