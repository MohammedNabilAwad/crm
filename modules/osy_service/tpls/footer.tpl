...
{*OPENSYMBOLMOD paolo.santacatterina (13/feb/2013  12:28:27)*}
{*Nascosto pannello Scheduling*}
...
{literal}
SUGAR.osy_service = {};
var osy_serviceLoader = new YAHOO.util.YUILoader({
    ...
    onSuccess: function(){
		SUGAR.osy_service.fill_invitees = function() {
		...
		if ( document.getElementById('save_and_continue') ) {
			...
			document.getElementById('save_and_continue').onclick = function(){
				SUGAR.osy_service.fill_invitees();
				eval(oldclick);
			}
		}
	}
});
osy_serviceLoader.addModule({
