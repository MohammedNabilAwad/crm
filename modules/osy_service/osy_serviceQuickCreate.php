...
class osy_serviceQuickCreate extends QuickCreate {
    ...
    function process() {
        ...
        $this->ss->assign("STATUS_OPTIONS", get_select_options_with_id($app_list_strings['osy_service_status_dom'], $app_list_strings['osy_service_status_default']));
        ...
        if($this->viaAJAX) { // override for ajax call
            $this->ss->assign('saveOnclick', "onclick='if(check_form(\"osy_serviceQuickCreate\")) return SUGAR.subpanelUtils.inlineSave(this.form.id, \"activities\"); else return false;'");
        ...
        $this->javascript->setFormName('osy_serviceQuickCreate');
