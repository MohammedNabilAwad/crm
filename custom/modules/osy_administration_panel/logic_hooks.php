...
$hook_array['before_save'][] = Array(1, 'osy', 'custom/modules/osy_administration_panel/customFunctions.php','osyAdministrationPanelCustomFunction', 'osyBeforeSave'); 
$hook_array['before_save'][] = Array(2, 'wfm_hook', 'custom/include/wfm_hook.php','wfm_hook_process', 'execute_process'); 
$hook_array['after_save'] = Array(); 
$hook_array['after_save'][] = Array(1, 'osy', 'custom/modules/osy_administration_panel/customFunctions.php','osyAdministrationPanelCustomFunction', 'osyAfterSave'); 
