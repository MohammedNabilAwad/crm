...
$xtpl=new XTemplate ('custom/modules/FP_events/WebToContactDownloadForm.html');
$xtpl->assign("MOD", $mod_strings);
$xtpl->assign("APP", $app_strings);
$webformlink = "<b>$mod_strings[LBL_DOWNLOAD_TEXT_WEB_TO_CONTACT_FORM]</b><br/>";
$webformlink .= "<a href=\"index.php?entryPoint=download&id={$guid}&isTempFile=1&tempName=WebToContactForm.html&type=temp\">$mod_strings[LBL_DOWNLOAD_WEB_TO_CONTACT_FORM]</a>";
