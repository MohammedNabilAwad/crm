...
$hook_array['before_save'][] = Array(1, 'osy', 'custom/modules/Leads/customFunctions.php','osyCustomFunctionLeads', 'osyBeforeSave'); 
...
$hook_array['after_save'][] = Array(1, 'osy', 'custom/modules/Leads/customFunctions.php','osyCustomFunctionLeads', 'osyAfterSave'); 
