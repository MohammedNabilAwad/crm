...
class CustomViewConvertLead extends ViewConvertLead {
    ...
    public function display()
    {
        ...
        if ($sugar_config ['lead_conv_activity_opt'] == 'move') {
            $smarty->assign ( 'convertModuleListOptions', get_select_options_with_id ( array (
                    'None' => $app_strings ['LBL_NONE'],
    ...
    protected function handleSave()
    {
        ...
        foreach ($beans as $bean)
        {
            ...
            // OPENSYMBOLMOD - START - davide.dallapozza - 17:46:14
            // *************************************************
    ...
    )
    {
        ...
        if (!empty($vdef['ConvertLead']['select']))
        {
            ...
            if (!empty($contactRel))
            {
                $bean->id = create_guid();
                $bean->new_with_id = true;
                // OPENSYMBOLMOD - START - davide.dallapozza - 17:46:32
                // *************************************************
