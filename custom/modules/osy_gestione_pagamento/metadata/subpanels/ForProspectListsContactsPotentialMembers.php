...
$subpanel_layout = array(
	...
	'where' => " prospect_lists_prospects.related_type = 'osy_contactspotentialmember' ",
...
// 			'return_field' => '',
			'customCode' => '
				{php}
					...
					$lead = BeanFactory::getBean("Leads" ,$GLOBALS["osyContactsProspectListsBeans"][ $this->_tpl_vars["aLayoutDefs"]["fields"]["RELATED_ID"] ] -> lead_id);
					if($lead)
						echo $lead-> account_name;
				{/php}
			',
		),
