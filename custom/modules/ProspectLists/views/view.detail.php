...
class CustomProspectListsViewDetail extends ViewDetail {
 	function CustomProspectListsViewDetail(){
 		parent::ViewDetail();
 	}	
 		...
 		echo '
	 		<script>
				SUGAR.util.doWhen(\'typeof(document.getElementsByTagName("body")[0]) != "undefined"\', function() {
					if($("#osy_campaign_id_detailview").val() == ""){
						$("#return_campaign_btn").remove();
					}
				});
			</script>
 		';
