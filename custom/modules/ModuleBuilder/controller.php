...
class ModuleBuilderController extends SugarController
{
    ...
    {
        if(file_exists('custom/modules/ModuleBuilder/parsers/parser.label.php')){
            require_once 'custom/modules/ModuleBuilder/parsers/parser.label.php' ;
            $parser = new ParserLabelCustom ( $_REQUEST['view_module'] , isset ( $_REQUEST [ 'view_package' ] ) ? $_REQUEST [ 'view_package' ] : null ) ;
        }
        else{
