...
$mod_strings['LBL_ZUCKERREPORTS2_LOCALJDK_EXECMODE_HELP'] = 'There are several possibilities to run an external command (as Java) in PHP. The default option is "exec", but as behaviour is inconsistent between PHP and OS versions, it may be worth a try to swicht to "shell_exec" - especially if ZuckerReports doesn\'t show detailed error messages on Report Execption or Report compilation.';
