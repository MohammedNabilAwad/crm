...
$app_list_strings['moduleList']['AOS_PDF_Templates'] = 'Modèles de PDF';
...
$app_list_strings['quote_stage_dom']['Closed Accepted'] = 'Affaire gagnée';
...
$app_list_strings['invoice_status_dom']['Paid'] = 'Payée';
$app_list_strings['invoice_status_dom']['Unpaid'] = 'Non payée';
$app_list_strings['invoice_status_dom']['Cancelled'] = 'Annulée';
$app_list_strings['invoice_status_dom'][''] = '';
$app_list_strings['quote_invoice_status_dom']['Not Invoiced'] = 'Non facturée';
$app_list_strings['quote_invoice_status_dom']['Invoiced'] = 'Facturée';
$app_list_strings['product_code_dom']['XXXX'] = 'XXXX';
$app_list_strings['product_code_dom']['YYYY'] = 'YYYY';
$app_list_strings['product_category_dom']['Laptops'] = 'Ordinateur portable';
...
$app_list_strings['contract_status_list']['Signed'] = 'Signée';
$app_list_strings['contract_type_list']['Type'] = 'Type';
$app_strings['LBL_GENERATE_LETTER'] = 'Générer une lettre';
$app_strings['LBL_SELECT_TEMPLATE'] = 'Merci de choisir un modèle';
$app_strings['LBL_NO_TEMPLATE'] = 'ERREUR\nAucun modèle trouvé.\nMerci d en créer un dans le module de création de modèle PDF';
