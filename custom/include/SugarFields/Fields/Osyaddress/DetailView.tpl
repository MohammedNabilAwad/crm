...
<input type="hidden" class="sugar_field" id="{{$displayParams.key}}_address_region_c" value="{$fields.{{$displayParams.key}}_address_region_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
<input type="hidden" class="sugar_field" id="{{$displayParams.key}}_address_pobox_c" value="{$fields.{{$displayParams.key}}_address_pobox_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
...
<input type="hidden" class="sugar_field" id="{{$displayParams.key}}_address_other" value="{$fields.{{$displayParams.key}}_address_other.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
{$fields.{{$displayParams.key}}_address_street.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}<br>


{$fields.{{$displayParams.key}}_address_city.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br} {$fields.{{$displayParams.key}}_address_state.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}&nbsp;&nbsp;{$fields.{{$displayParams.key}}_address_pobox_c.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}&nbsp;&nbsp;{$fields.{{$displayParams.key}}_address_postalcode.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}<br>
{$fields.{{$displayParams.key}}_address_region_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}
{$fields.{{$displayParams.key}}_address_other.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}
</td>
