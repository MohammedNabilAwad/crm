...
class SugarWidgetSubPanelDetailViewLink extends SugarWidgetField
{
	function displayList(&$layout_def)
	{
        ...
        {
        	//OPENSYMBOLMOD paolo.santacatterina (05/feb/2014  11:06:39)
        	//PITCILO-4
        	//************************************************************
        	if($_REQUEST['module'] == 'Campaigns' && $module == 'ProspectLists'){
        		if(isset($focus->id) && $focus->id != '')
        			$osy_campaign_id_detailview = $focus->id;
        		else
        			$osy_campaign_id_detailview = $_REQUEST['record'];
        		$link = ajaxLink("index.php?module=$module&action=$action&record={$record}{$parent}&osy_campaign_id_detailview={$osy_campaign_id_detailview}");
        	}
        	else{
